...
public class DurationSelector extends JFrame {
    ...
    public static void main(String[] args) {
        // Create and show the duration selector frame
        DurationSelector timer = new DurationSelector();
        timer.setVisible(true);
        timer.setSize(800,550);
        JPanel panel2 = new JPanel(new FlowLayout());
panel2.add(timer);

        JPanel panel1 = new JPanel(new FlowLayout());
        panel1.setLayout(null);
        JLabel label1 = new JLabel("Please choose your color");
        ...
        start.setBounds(650, 450, 100, 100);
